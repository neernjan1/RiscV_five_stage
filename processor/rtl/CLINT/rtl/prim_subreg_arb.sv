// clint_prim_subreg_pkg is declared in prim_subreg.sv, which `includes this
// file -- not redeclared here to avoid a duplicate package declaration once
// textually combined.
import prim_mubi_pkg::*;
module clint_prim_subreg_arb import clint_prim_subreg_pkg::*;
#(
  parameter int         DW       = 32,
