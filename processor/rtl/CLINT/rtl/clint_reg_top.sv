// clint_prim_subreg_pkg is declared in prim_subreg.sv -- not redeclared here
// to avoid a duplicate package declaration across the design.
`include "common_cells_assertions.vh"
`include "typdef.vh"
`include "assign.vh"
